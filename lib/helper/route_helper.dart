...
import 'package:user_app_web/common/widgets/image_viewer_screen.dart';
import 'package:user_app_web/common/widgets/not_found.dart';
import 'package:user_app_web/features/address/domain/models/address_model.dart';
import 'package:user_app_web/features/address/screens/add_address_screen.dart';
import 'package:user_app_web/features/address/screens/address_screen.dart';
...
import 'package:user_app_web/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:user_app_web/features/auth/screens/sign_in_screen.dart';
import 'package:user_app_web/features/auth/screens/sign_up_screen.dart';
import 'package:user_app_web/features/auth/screens/store_registration_screen.dart';
import 'package:user_app_web/features/brands/screens/brands_product_screen.dart';
import 'package:user_app_web/features/brands/screens/brands_screen.dart';
import 'package:user_app_web/features/business/screens/subscription_payment_screen.dart';
import 'package:user_app_web/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:user_app_web/features/cart/screens/cart_screen.dart';
import 'package:user_app_web/features/category/screens/category_item_screen.dart';
import 'package:user_app_web/features/category/screens/category_screen.dart';
import 'package:user_app_web/features/chat/domain/models/conversation_model.dart';
import 'package:user_app_web/features/chat/screens/chat_screen.dart';
import 'package:user_app_web/features/chat/screens/conversation_screen.dart';
...
import 'package:user_app_web/features/checkout/screens/order_successful_screen.dart';
import 'package:user_app_web/features/coupon/screens/coupon_screen.dart';
import 'package:user_app_web/features/dashboard/screens/dashboard_screen.dart';
import 'package:user_app_web/features/favourite/screens/favourite_screen.dart';
import 'package:user_app_web/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:user_app_web/features/html/screens/html_viewer_screen.dart';
import 'package:user_app_web/features/interest/screens/interest_screen.dart';
...
import 'package:user_app_web/features/item/screens/item_campaign_screen.dart';
import 'package:user_app_web/features/item/screens/item_details_screen.dart';
import 'package:user_app_web/features/item/screens/popular_item_screen.dart';
import 'package:user_app_web/features/language/screens/language_screen.dart';
import 'package:user_app_web/features/location/screens/access_location_screen.dart';
import 'package:user_app_web/features/location/screens/map_screen.dart';
import 'package:user_app_web/features/location/screens/pick_map_screen.dart';
import 'package:user_app_web/features/loyalty/screens/loyalty_screen.dart';
import 'package:user_app_web/features/notification/domain/models/notification_body_model.dart';
import 'package:user_app_web/features/notification/screens/notification_screen.dart';
import 'package:user_app_web/features/onboard/screens/onboarding_screen.dart';
import 'package:user_app_web/features/order/domain/models/order_model.dart';
import 'package:user_app_web/features/order/screens/guest_track_order_screen.dart';
import 'package:user_app_web/features/order/screens/order_details_screen.dart';
import 'package:user_app_web/features/order/screens/order_screen.dart';
import 'package:user_app_web/features/order/screens/order_tracking_screen.dart';
import 'package:user_app_web/features/order/screens/refund_request_screen.dart';
...
import 'package:user_app_web/features/parcel/screens/parcel_location_screen.dart';
import 'package:user_app_web/features/parcel/screens/parcel_request_screen.dart';
import 'package:user_app_web/features/payment/screens/offline_payment_screen.dart';
import 'package:user_app_web/features/payment/screens/payment_screen.dart';
import 'package:user_app_web/features/payment/screens/payment_webview_screen.dart';
import 'package:user_app_web/features/profile/screens/profile_screen.dart';
import 'package:user_app_web/features/profile/screens/update_profile_screen.dart';
import 'package:user_app_web/features/refer_and_earn/screens/refer_and_earn_screen.dart';
import 'package:user_app_web/features/review/screens/review_screen.dart';
import 'package:user_app_web/features/search/screens/search_screen.dart';
import 'package:user_app_web/features/splash/controllers/splash_controller.dart';
import 'package:user_app_web/features/splash/screens/splash_screen.dart';
import 'package:user_app_web/features/store/domain/models/store_model.dart';
import 'package:user_app_web/features/store/screens/all_store_screen.dart';
import 'package:user_app_web/features/store/screens/campaign_screen.dart';
import 'package:user_app_web/features/store/screens/store_item_search_screen.dart';
import 'package:user_app_web/features/store/screens/store_screen.dart';
import 'package:user_app_web/features/support/screens/support_screen.dart';
import 'package:user_app_web/features/update/screens/update_screen.dart';
import 'package:user_app_web/features/verification/screens/forget_pass_screen.dart';
import 'package:user_app_web/features/verification/screens/new_pass_screen.dart';
import 'package:user_app_web/features/verification/screens/verification_screen.dart';
import 'package:user_app_web/features/wallet/screens/wallet_screen.dart';
...
class RouteHelper {
  ...
  static String getAddAddressRoute(bool fromCheckout, bool fromRide, int? zoneId, {bool isNavbar = false}) =>
  ...
  static String getSubscriptionSuccessRoute({String? status, required bool fromSubscription, int? storeId}) =>
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          int? createUserId =
              Get.parameters['create_user_id'] != null && Get.parameters['create_user_id'] != 'null' ? int.parse(Get.parameters['create_user_id']!) : null;
    ...
    GetPage(
        ...
        page: () => getRoute(ReviewScreen(
            ...
            store: Store.fromJson(jsonDecode(utf8.decode(base64Url.decode(Get.parameters['store']!.replaceAll(' ', '+')))))))),
    GetPage(
        name: allStores,
    ...
    GetPage(
        name: itemDetails,
        page: () => getRoute(
            Get.arguments ?? ItemDetailsScreen(item: Item(id: int.parse(Get.parameters['id']!)), inStorePage: Get.parameters['page'] == 'restaurant'))),
    GetPage(
        name: wallet,
        page: () {
    ...
    GetPage(
        ...
        page: () {
          ...
          return getRoute(ChatScreen(
            ...
            fromNotification: Get.parameters['from'] == 'true',
            conversationID: (Get.parameters['conversation_id'] != null && Get.parameters['conversation_id'] != 'null')
    ...
    GetPage(
      ...
      page: () {
        ...
        return OfflinePaymentScreen(
          ...
          maxCodOrderAmount:
              (Get.parameters['max_cod_amount'] != null && Get.parameters['max_cod_amount'] != 'null') ? double.parse(Get.parameters['max_cod_amount']!) : null,
    ...
    GetPage(
        ...
        page: () => SubscriptionPaymentScreen(storeId: int.parse(Get.parameters['store-id']!), packageId: int.parse(Get.parameters['package-id']!))),
  ];
