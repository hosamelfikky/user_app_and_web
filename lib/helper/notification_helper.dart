...
class NotificationHelper {
  static Future<void> initialize(FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    ...
    flutterLocalNotificationsPlugin.initialize(initializationsSettings, onDidReceiveNotificationResponse: (NotificationResponse load) async {
      try {
        ...
        if (load.payload!.isNotEmpty) {
          ...
          } else if (payload.notificationType == NotificationType.otp ||
              payload.notificationType == NotificationType.block ||
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      if (kDebugMode) {
        log("onMessage: ${message.data['type']}/${message.data}");
      }
        ...
        if (message.data.isNotEmpty) {
          ...
          if (notificationBody.notificationType == NotificationType.order) {
            ...
            Get.offAllNamed(RouteHelper.getNotificationRoute(fromNotification: true));
              ...
              notificationBody.notificationType == NotificationType.block ||
            ...
            Get.offAllNamed(
                RouteHelper.getChatRoute(notificationBody: notificationBody, conversationID: notificationBody.conversationId, fromNotification: true));
          }
        }
      } catch (_) {}
    });
  ...
  static Future<void> showTextNotification(
      String title, String body, String orderID, NotificationBodyModel? notificationBody, FlutterLocalNotificationsPlugin fln) async {
  ...
  static Future<void> showBigPictureNotificationHiddenLargeIcon(
      String? title, String? body, String? orderID, NotificationBodyModel? notificationBody, String image, FlutterLocalNotificationsPlugin fln) async {
