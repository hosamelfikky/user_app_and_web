...
import '../features/address/domain/repositories/address_repository_interface.dart';
import '../features/address/domain/services/address_service.dart';
import '../features/address/domain/services/address_service_interface.dart';
import '../features/auth/controllers/auth_controller.dart';
import '../features/auth/controllers/deliveryman_registration_controller.dart';
import '../features/auth/controllers/store_registration_controller.dart';
import '../features/auth/domain/reposotories/auth_repository.dart';
import '../features/auth/domain/reposotories/auth_repository_interface.dart';
import '../features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import '../features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import '../features/auth/domain/reposotories/store_registration_repository.dart';
import '../features/auth/domain/reposotories/store_registration_repository_interface.dart';
import '../features/auth/domain/services/auth_service.dart';
import '../features/auth/domain/services/auth_service_interface.dart';
import '../features/auth/domain/services/deliveryman_registration_service.dart';
import '../features/auth/domain/services/deliveryman_registration_service_interface.dart';
import '../features/auth/domain/services/store_registration_service.dart';
import '../features/auth/domain/services/store_registration_service_interface.dart';
...
import '../features/banner/domain/repositories/banner_repository_interface.dart';
import '../features/banner/domain/services/banner_service.dart';
import '../features/banner/domain/services/banner_service_interface.dart';
import '../features/brands/controllers/brands_controller.dart';
import '../features/brands/domain/repositories/brands_repository.dart';
import '../features/brands/domain/repositories/brands_repository_interface.dart';
import '../features/brands/domain/services/brands_service.dart';
import '../features/brands/domain/services/brands_service_interface.dart';
import '../features/business/controllers/business_controller.dart';
import '../features/business/domain/repositories/business_repo.dart';
import '../features/business/domain/repositories/business_repo_interface.dart';
import '../features/business/domain/services/business_service.dart';
import '../features/business/domain/services/business_service_interface.dart';
import '../features/cart/controllers/cart_controller.dart';
import '../features/cart/domain/repositories/cart_repository.dart';
import '../features/cart/domain/repositories/cart_repository_interface.dart';
import '../features/cart/domain/services/cart_service.dart';
import '../features/cart/domain/services/cart_service_interface.dart';
import '../features/category/controllers/category_controller.dart';
import '../features/category/domain/reposotories/category_repository.dart';
import '../features/category/domain/reposotories/category_repository_interface.dart';
import '../features/category/domain/services/category_service.dart';
import '../features/category/domain/services/category_service_interface.dart';
...
import '../features/chat/domain/services/chat_service_interface.dart';
import '../features/checkout/controllers/checkout_controller.dart';
import '../features/checkout/domain/repositories/checkout_repository.dart';
import '../features/checkout/domain/repositories/checkout_repository_interface.dart';
import '../features/checkout/domain/services/checkout_service.dart';
import '../features/checkout/domain/services/checkout_service_interface.dart';
...
import '../features/coupon/domain/repositories/coupon_repository_interface.dart';
import '../features/coupon/domain/services/coupon_service.dart';
import '../features/coupon/domain/services/coupon_service_interface.dart';
...
import '../features/favourite/domain/repositories/favourite_repository_interface.dart';
import '../features/favourite/domain/services/favourite_service.dart';
import '../features/favourite/domain/services/favourite_service_interface.dart';
import '../features/flash_sale/controllers/flash_sale_controller.dart';
import '../features/flash_sale/domain/repositories/flash_sale_repository.dart';
import '../features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import '../features/flash_sale/domain/services/flash_sale_service.dart';
import '../features/flash_sale/domain/services/flash_sale_service_interface.dart';
import '../features/home/controllers/advertisement_controller.dart';
import '../features/home/controllers/home_controller.dart';
import '../features/home/domain/repositories/advertisement_repository.dart';
import '../features/home/domain/repositories/advertisement_repository_interface.dart';
import '../features/home/domain/repositories/home_repository.dart';
import '../features/home/domain/repositories/home_repository_interface.dart';
import '../features/home/domain/services/advertisement_service.dart';
import '../features/home/domain/services/advertisement_service_interface.dart';
import '../features/home/domain/services/home_service.dart';
import '../features/home/domain/services/home_service_interface.dart';
import '../features/html/controllers/html_controller.dart';
import '../features/html/domain/repositories/html_repository.dart';
import '../features/html/domain/repositories/html_repository_interface.dart';
import '../features/html/domain/services/html_service.dart';
import '../features/html/domain/services/html_service_interface.dart';
import '../features/item/controllers/campaign_controller.dart';
import '../features/item/controllers/item_controller.dart';
import '../features/item/domain/repositories/campaign_repository.dart';
import '../features/item/domain/repositories/campaign_repository_interface.dart';
import '../features/item/domain/repositories/item_repository.dart';
import '../features/item/domain/repositories/item_repository_interface.dart';
import '../features/item/domain/services/campaign_service.dart';
import '../features/item/domain/services/campaign_service_interface.dart';
import '../features/item/domain/services/item_service.dart';
import '../features/item/domain/services/item_service_interface.dart';
...
import '../features/language/domain/repository/language_repository_interface.dart';
import '../features/language/domain/service/language_service.dart';
import '../features/language/domain/service/language_service_interface.dart';
import '../features/location/controllers/location_controller.dart';
import '../features/location/domain/repositories/location_repository.dart';
import '../features/location/domain/repositories/location_repository_interface.dart';
import '../features/location/domain/services/location_service.dart';
import '../features/location/domain/services/location_service_interface.dart';
...
import '../features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import '../features/loyalty/domain/services/loyalty_service.dart';
import '../features/loyalty/domain/services/loyalty_service_interface.dart';
...
import '../features/notification/domain/repository/notification_repository_interface.dart';
import '../features/notification/domain/service/notification_service.dart';
import '../features/notification/domain/service/notification_service_interface.dart';
import '../features/onboard/controllers/onboard_controller.dart';
import '../features/onboard/domain/repository/onboard_repository.dart';
import '../features/onboard/domain/repository/onboard_repository_interface.dart';
import '../features/onboard/domain/service/onboard_service.dart';
import '../features/onboard/domain/service/onboard_service_interface.dart';
import '../features/order/controllers/order_controller.dart';
import '../features/order/domain/repositories/order_repository.dart';
import '../features/order/domain/repositories/order_repository_interface.dart';
import '../features/order/domain/services/order_service.dart';
import '../features/order/domain/services/order_service_interface.dart';
import '../features/parcel/controllers/parcel_controller.dart';
import '../features/parcel/domain/repositories/parcel_repository.dart';
import '../features/parcel/domain/repositories/parcel_repository_interface.dart';
import '../features/parcel/domain/services/parcel_service.dart';
import '../features/parcel/domain/services/parcel_service_interface.dart';
import '../features/payment/controllers/payment_controller.dart';
import '../features/payment/domain/repositories/payement_repository.dart';
...
import '../features/profile/domain/services/profile_service_interface.dart';
...
import '../features/review/domain/repositories/review_repository_interface.dart';
import '../features/review/domain/services/review_service.dart';
import '../features/review/domain/services/review_service_interface.dart';
import '../features/search/controllers/search_controller.dart';
import '../features/search/domain/repositories/search_repository.dart';
import '../features/search/domain/repositories/search_repository_interface.dart';
import '../features/search/domain/services/search_service.dart';
import '../features/search/domain/services/search_service_interface.dart';
...
import '../features/store/domain/repositories/store_repository_interface.dart';
import '../features/store/domain/services/store_service.dart';
import '../features/store/domain/services/store_service_interface.dart';
import '../features/verification/controllers/verification_controller.dart';
import '../features/verification/domein/reposotories/verification_repository.dart';
import '../features/verification/domein/reposotories/verification_repository_interface.dart';
import '../features/verification/domein/services/verification_service.dart';
import '../features/verification/domein/services/verification_service_interface.dart';
import '../features/wallet/controllers/wallet_controller.dart';
import '../features/wallet/domain/repositories/wallet_repository.dart';
import '../features/wallet/domain/repositories/wallet_repository_interface.dart';
import '../features/wallet/domain/services/wallet_service.dart';
import '../features/wallet/domain/services/wallet_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  DeliverymanRegistrationRepositoryInterface deliverymanRegistrationRepositoryInterface =
      DeliverymanRegistrationRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  ...
  DeliverymanRegistrationServiceInterface deliverymanRegistrationServiceInterface =
      DeliverymanRegistrationService(deliverymanRegistrationRepoInterface: Get.find(), authRepositoryInterface: Get.find());
  Get.lazyPut(() => deliverymanRegistrationServiceInterface);

  StoreRegistrationServiceInterface storeRegistrationServiceInterface =
      StoreRegistrationService(deliverymanRegistrationRepositoryInterface: Get.find(), storeRegistrationRepoInterface: Get.find());
