...
import 'package:user_app_web/features/address/domain/repositories/address_repository.dart';
import 'package:user_app_web/features/address/domain/repositories/address_repository_interface.dart';
import 'package:user_app_web/features/address/domain/services/address_service.dart';
...
import 'package:user_app_web/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:user_app_web/features/auth/controllers/store_registration_controller.dart';
import 'package:user_app_web/features/auth/domain/reposotories/auth_repository.dart';
import 'package:user_app_web/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:user_app_web/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:user_app_web/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:user_app_web/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:user_app_web/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:user_app_web/features/auth/domain/services/auth_service.dart';
import 'package:user_app_web/features/auth/domain/services/auth_service_interface.dart';
import 'package:user_app_web/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:user_app_web/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:user_app_web/features/auth/domain/services/store_registration_service.dart';
...
import 'package:user_app_web/features/banner/domain/repositories/banner_repository.dart';
import 'package:user_app_web/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:user_app_web/features/banner/domain/services/banner_service.dart';
...
import 'package:user_app_web/features/brands/domain/repositories/brands_repository.dart';
import 'package:user_app_web/features/brands/domain/repositories/brands_repository_interface.dart';
import 'package:user_app_web/features/brands/domain/services/brands_service.dart';
...
import 'package:user_app_web/features/business/domain/repositories/business_repo.dart';
import 'package:user_app_web/features/business/domain/repositories/business_repo_interface.dart';
import 'package:user_app_web/features/business/domain/services/business_service.dart';
...
import 'package:user_app_web/features/cart/domain/repositories/cart_repository.dart';
import 'package:user_app_web/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:user_app_web/features/cart/domain/services/cart_service.dart';
...
import 'package:user_app_web/features/category/domain/reposotories/category_repository.dart';
import 'package:user_app_web/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:user_app_web/features/category/domain/services/category_service.dart';
...
import 'package:user_app_web/features/chat/domain/repositories/chat_repository.dart';
import 'package:user_app_web/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:user_app_web/features/chat/domain/services/chat_service.dart';
...
import 'package:user_app_web/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:user_app_web/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:user_app_web/features/checkout/domain/services/checkout_service.dart';
import 'package:user_app_web/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:user_app_web/features/coupon/controllers/coupon_controller.dart';
import 'package:user_app_web/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:user_app_web/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:user_app_web/features/coupon/domain/services/coupon_service.dart';
...
import 'package:user_app_web/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:user_app_web/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:user_app_web/features/favourite/domain/services/favourite_service.dart';
...
import 'package:user_app_web/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:user_app_web/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:user_app_web/features/flash_sale/domain/services/flash_sale_service.dart';
...
import 'package:user_app_web/features/home/domain/repositories/advertisement_repository.dart';
import 'package:user_app_web/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:user_app_web/features/home/domain/repositories/home_repository.dart';
import 'package:user_app_web/features/home/domain/repositories/home_repository_interface.dart';
import 'package:user_app_web/features/home/domain/services/advertisement_service.dart';
import 'package:user_app_web/features/home/domain/services/advertisement_service_interface.dart';
import 'package:user_app_web/features/home/domain/services/home_service.dart';
import 'package:user_app_web/features/home/domain/services/home_service_interface.dart';
import 'package:user_app_web/features/html/controllers/html_controller.dart';
import 'package:user_app_web/features/html/domain/repositories/html_repository.dart';
import 'package:user_app_web/features/html/domain/repositories/html_repository_interface.dart';
import 'package:user_app_web/features/html/domain/services/html_service.dart';
...
import 'package:user_app_web/features/item/domain/repositories/campaign_repository.dart';
import 'package:user_app_web/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:user_app_web/features/item/domain/repositories/item_repository.dart';
import 'package:user_app_web/features/item/domain/repositories/item_repository_interface.dart';
import 'package:user_app_web/features/item/domain/services/campaign_service.dart';
import 'package:user_app_web/features/item/domain/services/campaign_service_interface.dart';
import 'package:user_app_web/features/item/domain/services/item_service.dart';
...
import 'package:user_app_web/features/language/domain/repository/language_repository.dart';
import 'package:user_app_web/features/language/domain/repository/language_repository_interface.dart';
import 'package:user_app_web/features/language/domain/service/language_service.dart';
...
import 'package:user_app_web/features/location/domain/repositories/location_repository.dart';
import 'package:user_app_web/features/location/domain/repositories/location_repository_interface.dart';
import 'package:user_app_web/features/location/domain/services/location_service.dart';
...
import 'package:user_app_web/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:user_app_web/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:user_app_web/features/loyalty/domain/services/loyalty_service.dart';
...
import 'package:user_app_web/features/notification/domain/repository/notification_repository.dart';
import 'package:user_app_web/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:user_app_web/features/notification/domain/service/notification_service.dart';
...
import 'package:user_app_web/features/onboard/domain/repository/onboard_repository.dart';
import 'package:user_app_web/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:user_app_web/features/onboard/domain/service/onboard_service.dart';
...
import 'package:user_app_web/features/order/domain/repositories/order_repository.dart';
import 'package:user_app_web/features/order/domain/repositories/order_repository_interface.dart';
import 'package:user_app_web/features/order/domain/services/order_service.dart';
...
import 'package:user_app_web/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:user_app_web/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:user_app_web/features/parcel/domain/services/parcel_service.dart';
import 'package:user_app_web/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:user_app_web/features/payment/controllers/payment_controller.dart';
import 'package:user_app_web/features/payment/domain/repositories/payement_repository.dart';
import 'package:user_app_web/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:user_app_web/features/payment/domain/services/payment_service.dart';
...
import 'package:user_app_web/features/profile/domain/repositories/profile_repository.dart';
import 'package:user_app_web/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:user_app_web/features/profile/domain/services/profile_service.dart';
...
import 'package:user_app_web/features/review/domain/repositories/review_repository.dart';
import 'package:user_app_web/features/review/domain/repositories/review_repository_interface.dart';
import 'package:user_app_web/features/review/domain/services/review_service.dart';
import 'package:user_app_web/features/review/domain/services/review_service_interface.dart';
import 'package:user_app_web/features/search/controllers/search_controller.dart';
import 'package:user_app_web/features/search/domain/repositories/search_repository.dart';
import 'package:user_app_web/features/search/domain/repositories/search_repository_interface.dart';
import 'package:user_app_web/features/search/domain/services/search_service.dart';
import 'package:user_app_web/features/search/domain/services/search_service_interface.dart';
import 'package:user_app_web/features/splash/controllers/splash_controller.dart';
import 'package:user_app_web/features/splash/domain/repositories/splash_repository.dart';
import 'package:user_app_web/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:user_app_web/features/splash/domain/services/splash_service.dart';
...
import 'package:user_app_web/features/store/domain/repositories/store_repository.dart';
import 'package:user_app_web/features/store/domain/repositories/store_repository_interface.dart';
import 'package:user_app_web/features/store/domain/services/store_service.dart';
import 'package:user_app_web/features/store/domain/services/store_service_interface.dart';
import 'package:user_app_web/features/verification/controllers/verification_controller.dart';
import 'package:user_app_web/features/verification/domein/reposotories/verification_repository.dart';
import 'package:user_app_web/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:user_app_web/features/verification/domein/services/verification_service.dart';
...
import 'package:user_app_web/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:user_app_web/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:user_app_web/features/wallet/domain/services/wallet_service.dart';
