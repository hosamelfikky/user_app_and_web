...
import 'custom_tool_tip_widget.dart';
...
class _ItemBottomSheetState extends State<ItemBottomSheet> {
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                        ...
                                        onTap: () {
                                          if (AuthHelper.isLoggedIn()) {
                                            wishList.wishItemIdList.contains(widget.item!.id)
                                                ? wishList.removeFromFavouriteList(widget.item!.id, false, getXSnackBar: true)
                              ...
                              widget.item!.isStoreHalalActive! && widget.item!.isHalalItem!
                                  ? Padding(
                                          ...
                                          ? Container(
                                              ...
                                              child: Get.find<SplashController>().configModel!.moduleConfig!.module!.unit!
                                                  ...
                                                  : Row(children: [
                                                      ...
                                                      Text(widget.item!.veg == 1 ? 'veg'.tr : 'non_veg'.tr,
                          ...
                          _newVariation
                              ? NewVariationView(
                                  ...
                                  showOriginalPrice: (price > priceWithDiscount) && (discountType == 'percent'),
                                )
                              : VariationView(
                                  item: widget.item,
                                  itemController: itemController,
                          ...
                          SizedBox(
                              height: (Get.find<SplashController>().configModel!.moduleConfig!.module!.addOn! && widget.item!.addOns!.isNotEmpty)
                                  ? Dimensions.paddingSizeLarge
                                  : 0),

                          // Addons
                          (Get.find<SplashController>().configModel!.moduleConfig!.module!.addOn! && widget.item!.addOns!.isNotEmpty)
                              ? AddonView(itemController: itemController, item: widget.item!)
                              : const SizedBox(),
                ...
                (!widget.item!.scheduleOrder! && !isAvailable)
                    ...
                    : Container(
                        decoration: BoxDecoration(
                          color: Theme.of(context).cardColor,
                          borderRadius: GetPlatform.isWeb
                              ? const BorderRadius.only(bottomLeft: Radius.circular(20), bottomRight: Radius.circular(40))
                                ...
                                discount! > 0
                                    ? PriceConverter.convertAnimationPrice(
                                        ...
                                        textStyle: robotoMedium.copyWith(
                                            color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                                      )
                                    : const SizedBox(),
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                PriceConverter.convertAnimationPrice(
  ...
  List<OrderVariation> _getSelectedVariations(
      {required bool isFoodVariation, required List<FoodVariation>? foodVariations, required List<List<bool?>> selectedVariations}) {
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Expanded(
                              child: InkWell(
                                ...
                                child: Center(
                                    child: Icon(
                                  (itemController.addOnQtyList[index]! > 1) ? Icons.remove : Icons.delete_outline_outlined,
                                  size: 18,
...
class NewVariationView extends StatelessWidget {
  ...
  const NewVariationView(
      {super.key, required this.item, required this.itemController, required this.discount, required this.discountType, required this.showOriginalPrice});
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: itemController.selectedVariations[index].contains(true) ? Theme.of(context).primaryColor : Theme.of(context).disabledColor,
                        width: 0.5),
                    borderRadius: BorderRadius.circular(Dimensions.radiusDefault)),
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        color: item!.foodVariations![index].required! &&
                                (item!.foodVariations![index].multiSelect! ? item!.foodVariations![index].min! : 1) > selectedCount
                  ...
                  ListView.builder(
                    ...
                    itemCount: itemController.collapseVariation[index]
                        ? item!.foodVariations![index].variationValues!.length > 4
                            ? 5
                            ...
                            child: Row(children: [
                              Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                ...
                                Text(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  style:
                                      itemController.selectedVariations[index][i]! ? robotoMedium : robotoRegular.copyWith(color: Theme.of(context).hintColor),
                                ),
                              ]),
                              const Spacer(),
                              showOriginalPrice
                              ...
                              Text(
                                ...
                                overflow: TextOverflow.ellipsis,
                                textDirection: TextDirection.ltr,
                                style: itemController.selectedVariations[index][i]!
