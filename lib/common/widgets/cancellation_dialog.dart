...
class CancellationDialog extends StatelessWidget {
  ...
  const CancellationDialog({super.key, required this.icon, this.title, required this.onYesPressed, this.isLogOut = false, this.onNoPressed});
                      ...
                      ? Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: Theme.of(context).colorScheme.error.withOpacity(.7), borderRadius: const BorderRadius.all(Radius.circular(8))),
                            child: Center(
                                child: Text(
                              'yes'.tr,
