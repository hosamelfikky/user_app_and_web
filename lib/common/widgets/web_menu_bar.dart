                              ...
                              return Row(
                                ...
                                children: [
                                  AuthHelper.isLoggedIn()
                                      ? Icon(
                                          AddressHelper.getUserAddressFromSharedPref()!.addressType == 'home'
                                              ? Icons.home_filled
                                              : AddressHelper.getUserAddressFromSharedPref()!.addressType == 'office'
                                                  ? Icons.work
                                                  : Icons.location_on,
                                          size: 16,
                ...
                GetBuilder<ThemeController>(builder: (themeController) {
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(themeController.darkTheme ? CupertinoIcons.moon_stars_fill : CupertinoIcons.sun_min_fill,
