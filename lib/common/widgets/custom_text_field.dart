          ...
          decoration: InputDecoration(
                ...
                ? Text.rich(TextSpan(children: [
                    TextSpan(
                        ...
                        style: robotoRegular.copyWith(
                            fontSize: widget.labelTextSize ?? Dimensions.fontSizeLarge, color: Theme.of(context).hintColor.withOpacity(.75))),
            ...
            prefixIcon: widget.isPhone
                ...
                : widget.prefixImage != null && widget.prefixIcon == null
                    ...
                    : widget.prefixImage == null && widget.prefixIcon != null
                        ? Icon(widget.prefixIcon, size: widget.iconSize, color: Theme.of(context).disabledColor)
                        : null,
