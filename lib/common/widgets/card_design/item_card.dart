...
class ItemCard extends StatelessWidget {
  ...
  final int? index;
  const ItemCard(
      {super.key, required this.item, this.isPopularItem = false, required this.isFood, required this.isShop, this.isPopularItemCart = false, this.index});
                  ...
                  (item.stock != null && item.stock! < 0)
                      ? Positioned(
                          ...
                          child: Container(
                            ...
                            child:
                                Text('out_of_stock'.tr, style: robotoRegular.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall)),
                          ),
                        )
                      : const SizedBox(),
                  isShop
                ...
                child: Padding(
                  ...
                  child: Stack(clipBehavior: Clip.none, children: [
                    Align(
                      ...
                      child: Column(
                          crossAxisAlignment: isPopularItem ? CrossAxisAlignment.center : CrossAxisAlignment.start,
