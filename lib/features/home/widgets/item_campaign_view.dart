...
class ItemCampaignView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CampaignController>(builder: (campaignController) {
      return (campaignController.itemCampaignList != null && campaignController.itemCampaignList!.isEmpty)
          ? const SizedBox()
          : Column(
              children: [
                Padding(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                    Stack(children: [
                                      ...
                                      DiscountTag(
                                        ...
                                        discountType: campaignController.itemCampaignList![index].storeDiscount! > 0
                                            ? 'percent'
