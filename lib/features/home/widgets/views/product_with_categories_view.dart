...
class _ProductWithCategoriesViewState extends State<ProductWithCategoriesView> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ItemController>(builder: (itemController) {
      ...
      List<Item>? products = [];
      if (widget.fromShop
          ? itemController.reviewedCategoriesList != null && itemController.reviewedItemList != null
          ...
          ? Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Padding(
                  ...
                  child: Text(widget.fromShop ? 'best_reviewed_products'.tr : 'basic_medicine_nearby'.tr,
                              ...
                              children: [
                                ...
                                isSelected
                                    ? Container(
                                        ...
                                        width: 35,
                                        decoration: BoxDecoration(
                                            borderRadius: const BorderRadius.vertical(bottom: Radius.circular(50)), color: Theme.of(context).cardColor),
                    ...
                    child: SizedBox(
                      height: ResponsiveHelper.isDesktop(context)
                          ...
                          : widget.fromShop
                              ...
                              : 247,
                      width: Get.width,
                      child: (widget.fromShop ? itemController.reviewedCategoriesList != null : itemController.basicMedicineModel != null)
                          ? ListView.builder(
                              scrollDirection: Axis.horizontal,
                              physics: const BouncingScrollPhysics(),
