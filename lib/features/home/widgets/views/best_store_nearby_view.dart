                      ...
                      (isPharmacy || isFood)
                          ...
                          : Padding(
                              padding: EdgeInsets.only(
                                  ...
                                  left: ltr ? Dimensions.paddingSizeLarge : Dimensions.paddingSizeDefault,
                              ...
                              child: FittedBox(
                                child: Row(children: [
                                  ...
                                  Container(
                                      ...
                                      child: Icon(Icons.arrow_forward, size: 18, color: Theme.of(context).primaryColor.withOpacity(0.5))),
                                  InkWell(
                          ...
                          ? SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    padding: const EdgeInsets.only(
                                        right: Dimensions.paddingSizeDefault, top: Dimensions.paddingSizeDefault, bottom: Dimensions.paddingSizeExtraSmall),
                                                ...
                                                Positioned(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      boxShadow: [
                                                        BoxShadow(
                                                            color: Colors.black.withOpacity(0.03), spreadRadius: 1, blurRadius: 7, offset: const Offset(0, 3))
                                                      ],
                                                    ),
                                                    child: Padding(
                                                              ...
                                                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'km'.tr}',
                                                                    style: robotoBold.copyWith(
                                                                        color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                                Text('from_you'.tr,
                                                                    style: robotoRegular.copyWith(
                                                                        color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
