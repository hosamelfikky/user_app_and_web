                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                padding: const EdgeInsets.only(
                                    bottom: Dimensions.paddingSizeLarge, right: Dimensions.paddingSizeSmall, top: Dimensions.paddingSizeExtremeLarge),
                                child: InkWell(
                                      ...
                                      child: Column(children: [
                                        Container(
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                                color: hovered ? Theme.of(context).primaryColor : Theme.of(context).cardColor, width: hovered ? 1 : 0),
                                          ),
                                          child: ClipRRect(
                                            borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                            child: CustomImage(
