                  ...
                  Column(children: [
                          ...
                          children: [
                            ...
                            Text('see_our_most_popular_store_and_item'.tr,
                                style: robotoRegular.copyWith(
                                    color: Get.isDarkMode ? Colors.white70 : Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                          ],
                        ),
                    ...
                    CarouselSlider.builder(
                      ...
                      options: CarouselOptions(
                        ...
                        scrollPhysics: advertisementController.advertisementList!.length > 2
