    ...
    return GetBuilder<ItemController>(builder: (itemController) {
      ...
      return itemList != null
          ? itemList.isNotEmpty
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              padding: const EdgeInsets.only(
                                  bottom: Dimensions.paddingSizeExtraLarge, right: Dimensions.paddingSizeDefault, top: Dimensions.paddingSizeExtraSmall),
                              child: ItemCard(
              ...
              : const SizedBox()
          : WebItemShimmerView(itemController: itemController, isPopularItem: true);
    });
  }
}
