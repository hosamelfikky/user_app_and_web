        ...
        isPharmacy
            ...
            : Padding(
                padding: const EdgeInsets.only(
                    top: Dimensions.paddingSizeExtremeLarge, left: Dimensions.paddingSizeExtraLarge, right: Dimensions.paddingSizeExtraLarge),
                child: FittedBox(
                  child: Row(children: [
                    Container(
                      height: 2,
                      width: ResponsiveHelper.isDesktop(context) ? Dimensions.webMaxWidth * 0.88 : Get.width * 0.75,
