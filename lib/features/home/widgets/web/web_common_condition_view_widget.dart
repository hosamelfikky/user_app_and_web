...
import 'web_basic_medicine_nearby_view_widget.dart';
...
class _WebCommonConditionViewWidgetState extends State<WebCommonConditionViewWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ItemController>(builder: (itemController) {
      ...
      return (itemController.commonConditions != null && itemController.commonConditions!.isNotEmpty)
          ? Container(
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    padding: const EdgeInsets.only(
                                        bottom: Dimensions.paddingSizeDefault, top: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeDefault),
