                  ...
                  ? Stack(
                      ...
                      children: [
                        ...
                        campaignController.currentIndex != 0
                            ...
                            : const SizedBox(),
                        campaignController.currentIndex != ((campaignController.basicCampaignList!.length / 2).ceil() - 1)
                            ? Positioned(
                                top: 0,
                                bottom: 0,
                                right: 0,
                        ...
                        child: index == campaignController.currentIndex
                            ...
                            : Container(
                                ...
                                decoration: BoxDecoration(
                                    color: Theme.of(context).primaryColor.withOpacity(0.5), borderRadius: BorderRadius.circular(Dimensions.radiusDefault)),
                              ),
                      );
                    }).toList(),
                  );
