                ...
                return Container(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      return Transform.rotate(angle: pi * value, child: carouselCard(index, widget.activeProducts[index]));
                    },
                  ),
                );
              }),
        ...
        Expanded(
          child: Padding(
            padding: EdgeInsets.symmetric(
              horizontal: ResponsiveHelper.isMobile(context) ? Dimensions.paddingSizeLarge : Dimensions.paddingSizeDefault,
