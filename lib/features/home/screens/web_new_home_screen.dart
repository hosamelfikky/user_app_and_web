...
import 'package:user_app_web/features/home/widgets/web/web_brands_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_highlight_widget.dart';
...
import 'package:user_app_web/features/home/widgets/web/middle_section_multiple_banner_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/module_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_basic_medicine_nearby_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_best_review_item_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_best_store_nearby_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_category_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_common_condition_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_coupon_banner_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_featured_categories_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_flash_sale_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_item_that_you_love_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_just_for_you_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_most_popular_item_banner_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_most_popular_item_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_new_banner_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_new_on_mart_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_new_on_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_populer_store_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_promotional_banner_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_recomanded_store_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_special_offer_view_widget.dart';
import 'package:user_app_web/features/home/widgets/web/web_visit_again_view_widget.dart';
...
import 'package:user_app_web/features/dashboard/widgets/address_bottom_sheet_widget.dart';
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: GetBuilder<BannerController>(builder: (bannerController) {
                          return bannerController.bannerImageList == null
                              ? const WebNewBannerViewWidget(isFeatured: false)
                      ...
                      GetBuilder<StoreController>(builder: (storeController) {
                        return GetBuilder<FlashSaleController>(builder: (flashController) {
                          bool isFlashSaleActive =
                              (flashController.flashSaleModel?.activeProducts != null && flashController.flashSaleModel!.activeProducts!.isNotEmpty);
                          return Expanded(
                            flex: 1,
                    ...
                    GetBuilder<CategoryController>(builder: (categoryController) {
                      return categoryController.categoryList == null
                          ? WebCategoryViewWidget(categoryController: categoryController)
                    ...
                    isPharmacy
                        ...
                        : isShop
                            ? const WebMostPopularItemViewWidget(isShop: true, isFood: false)
                    ...
                    isPharmacy
                        ...
                        : isFood
                            ...
                            : isShop
                                ? const WebSpecialOfferView(isFood: false, isShop: true)
                                : GetBuilder<CampaignController>(builder: (campaignController) {
                                    return campaignController.basicCampaignList == null
                                        ...
                                        : campaignController.basicCampaignList!.isEmpty
                                            ? const SizedBox()
                                            : WebMostPopularItemBannerViewWidget(campaignController: campaignController);
                                  }),
                    ...
                    isPharmacy
                        ...
                        : isFood
                            ? const WebMostPopularItemViewWidget(isFood: true, isShop: false)
                            : isShop
                                ? const WebBestReviewItemViewWidget()
                                : const WebBestReviewItemViewWidget(),
