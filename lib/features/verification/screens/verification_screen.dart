...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen({super.key, required this.number, required this.password, required this.fromSignUp, required this.token, this.firebaseSession});
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                GetBuilder<VerificationController>(builder: (verificationController) {
                  return GetBuilder<AuthController>(builder: (authController) {
                    return !authController.isLoading || !verificationController.isLoading
                        ? TextButton(
