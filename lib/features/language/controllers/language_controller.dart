...
import '../domain/service/language_service_interface.dart';
  ...
  void setLanguage(Locale locale, {bool fromBottomSheet = false}) {
    ...
    if (Get.find<SplashController>().moduleList == null) {
      Get.find<SplashController>().getModules(
          headers: {'Content-Type': 'application/json; charset=UTF-8', AppConstants.localizationKey: Get.find<LocalizationController>().locale.languageCode});
    }
