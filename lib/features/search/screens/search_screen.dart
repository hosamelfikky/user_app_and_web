...
import 'package:user_app_web/features/search/widgets/search_field_widget.dart';
import 'package:user_app_web/features/search/widgets/search_result_widget.dart';
                            ...
                            : Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    boxShadow: Get.find<ThemeController>().darkTheme
                                        ? null
                                        : [BoxShadow(color: Theme.of(context).disabledColor.withOpacity(0.2), blurRadius: 3, offset: const Offset(0, 5))]),
                    ...
                    child: searchController.isSearchMode
                        ? _showSuggestion
                            ...
                            : SingleChildScrollView(
                                padding:
                                    ResponsiveHelper.isDesktop(context) ? EdgeInsets.zero : const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                                child: FooterView(
                                  child: SizedBox(
                                      width: Dimensions.webMaxWidth,
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        searchController.historyList.isNotEmpty
                                            ? Padding(
                                                ...
                                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                  Text(ResponsiveHelper.isDesktop(context) ? 'recent_searches'.tr : 'your_last_search'.tr,
                                              ...
                                              return ResponsiveHelper.isDesktop(context)
                                                  ? Container(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            Text(searchController.historyList[index],
                                                                style: robotoRegular.copyWith(
                                        ...
                                        (_isLoggedIn && searchController.suggestedItemList != null)
                                            ? Text(
                                                'suggestions'.tr,
                                                style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                                              )
                                            ...
                                            ? searchController.suggestedItemList!.isNotEmpty
                                                ? GridView.builder(
                                                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                      ...
                                                      childAspectRatio: ResponsiveHelper.isMobile(context) ? (1 / 0.4) : (1.8 / 0.3),
                                        ...
                                        (searchController.popularCategoryList != null && searchController.popularCategoryList!.isNotEmpty)
                                            ? Text(
                                            ...
                                            : const SizedBox(),
                                        const SizedBox(height: Dimensions.paddingSizeSmall),
                                        searchController.popularCategoryList != null
                                            ? searchController.popularCategoryList!.isNotEmpty
                                                ...
                                                : Padding(padding: const EdgeInsets.only(top: 10), child: Text('no_category_available'.tr))
                                            : const SizedBox(),
                                      ])),
                                ),
                              )
                        : SearchResultWidget(
                            searchText: _searchController.text.trim(), tabController: ResponsiveHelper.isDesktop(context) ? _tabController : null)),
              ]);
            }),
          )),
