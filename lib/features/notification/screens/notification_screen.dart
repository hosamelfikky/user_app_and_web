...
import 'package:user_app_web/features/notification/widgets/notification_dialog_widget.dart';
            ...
            ? GetBuilder<NotificationController>(builder: (notificationController) {
                ...
                return notificationController.notificationList != null
                    ? notificationController.notificationList!.isNotEmpty
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        DateTime originalDateTime =
                                            DateConverter.dateTimeStringToDate(notificationController.notificationList![index].createdAt!);
                                        ...
                                        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          addTitle
                                              ? Padding(
                                                  ...
                                                  child:
                                                      Text(DateConverter.dateTimeStringToDateOnly(notificationController.notificationList![index].createdAt!)),
                                                )
                                              : const SizedBox(),
                                          InkWell(
                                            onTap: () {
                        ...
                        : NoDataScreen(text: 'no_notification_found'.tr, showFooter: true)
