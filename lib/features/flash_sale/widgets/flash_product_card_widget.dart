                          ...
                          ? Center(
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                        color: Theme.of(context).primaryColor.withOpacity(0.1), spreadRadius: 1, blurRadius: 5, offset: const Offset(0, 1))
                                  ],
                                ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  (Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! && product.item!.unitType != null)
                      ? Text(
                      ...
                      : const SizedBox(),
                  Wrap(children: [
                    product.item!.discount != null && product.item!.discount! > 0
                        ? Text(
                    ...
                    Text(
                      PriceConverter.convertPrice(
                        Get.find<ItemController>().getStartingPrice(product.item!),
