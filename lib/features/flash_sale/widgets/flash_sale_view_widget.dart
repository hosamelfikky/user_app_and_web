  ...
  Widget build(BuildContext context) {
    return GetBuilder<FlashSaleController>(builder: (flashSaleController) {
      ...
      return flashSaleController.flashSaleModel != null
          ? flashSaleController.flashSaleModel!.activeProducts != null && flashSaleController.duration!.inSeconds > 1
              ? Container(
                  width: Get.width,
                    ...
                    children: [
                      Padding(
                        ...
                        child: FittedBox(
                          child: CustomInkWell(
                            onTap: () =>
                                Get.toNamed(RouteHelper.getFlashSaleDetailsScreen(flashSaleController.flashSaleModel!.activeProducts![0].flashSaleId!)),
