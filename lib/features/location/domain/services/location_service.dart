...
class LocationService implements LocationServiceInterface {
  ...
  @override
  Future<void> authorizeNavigation(String page, List<AddressModel>? addressList, GoogleMapController? mapController,
        ...
        showGeneralDialog(
            ...
            pageBuilder: (_, __, ___) {
              return SizedBox(
                ...
                width: 300,
                child: PickMapScreen(
                    fromSignUp: (page == RouteHelper.signUp), canRoute: false, fromAddAddress: false, route: null, googleMapController: mapController),
              );
            });
      } else {
