...
import 'package:user_app_web/features/location/widgets/landing_card_widget.dart';
import 'package:user_app_web/features/location/widgets/registration_card_widget.dart';
import 'package:user_app_web/features/location/widgets/web_landing_page_shimmer_widget.dart';
...
class _WebLandingPageState extends State<WebLandingPage> {
  ...
  void initState() {
    ...
    if (Get.find<SplashController>().moduleList == null) {
      if (kDebugMode) log('-------call from web landing page------------');
                    ...
                    : Column(children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          splashController.landingModel?.fixedLocationTitle ?? '',
                                                  ...
                                                  pageBuilder: (_, __, ___) {
                                                    return SizedBox(
                                                      ...
                                                      child: PickMapScreen(
                                                        ...
                                                        route: widget.route ?? (widget.fromSignUp ? RouteHelper.signUp : RouteHelper.accessLocation),
                        ...
                        SizedBox(
                            height: splashController.landingModel != null &&
                                    (splashController.landingModel!.downloadUserAppLinks!.playstoreUrlStatus == '1' ||
                                        splashController.landingModel!.downloadUserAppLinks!.appleStoreUrlStatus == '1')
                                ? 40
                                : 0),
                        splashController.landingModel != null &&
                            ...
                            ? Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                ...
                                Column(children: [
                                  Text(
                                    splashController.landingModel!.downloadUserAppTitle ?? '',
                                    textAlign: TextAlign.center,
                                    style: robotoBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge),
                                  ),
                                  const SizedBox(height: Dimensions.paddingSizeSmall),
                                  Text(
                                    splashController.landingModel!.downloadUserAppSubTitle ?? '',
                                    textAlign: TextAlign.center,
                                    style: robotoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                                  ),
                                  const SizedBox(height: Dimensions.paddingSizeLarge),
                                  Row(children: [
                                    splashController.landingModel != null && splashController.landingModel!.downloadUserAppLinks!.playstoreUrlStatus == '1'
                                        ? InkWell(
                                            onTap: () async {
                                        ...
                                        : const SizedBox(),
                                    SizedBox(
                                        width: splashController.landingModel != null &&
                                                (splashController.landingModel!.downloadUserAppLinks!.playstoreUrlStatus == '1' &&
                                                    splashController.landingModel!.downloadUserAppLinks!.appleStoreUrlStatus == '1')
                                            ? Dimensions.paddingSizeLarge
                                            : 0),
                                    splashController.landingModel != null && splashController.landingModel!.downloadUserAppLinks!.appleStoreUrlStatus == '1'
                                        ? InkWell(
                                            onTap: () async {
  ...
  List<Widget> _generateChooseUsList(SplashController splashController) {
    ...
    for (int index = 0;
        index <
            (splashController.landingModel != null && splashController.landingModel!.specialCriterias!.length > 4
                ? 4
