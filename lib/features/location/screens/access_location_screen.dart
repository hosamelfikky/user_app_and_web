...
import 'package:user_app_web/features/location/screens/web_landing_page.dart';
                ...
                : isLoggedIn
                    ? Column(children: [
                        Expanded(
                          ...
                          child: FooterView(
                              child: Column(
                                  mainAxisAlignment: (locationController.addressList != null && locationController.addressList!.isNotEmpty)
                        ...
                        showGeneralDialog(
                            ...
                            pageBuilder: (_, __, ___) {
                              return SizedBox(
                                  ...
                                  width: 300,
                                  child: PickMapScreen(
                                      fromSignUp: fromSignUp, canRoute: route != null, fromAddAddress: false, route: route ?? RouteHelper.accessLocation));
                            });
                      } else {
