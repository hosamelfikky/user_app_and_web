...
import 'package:user_app_web/features/location/widgets/location_search_dialog_widget.dart';
...
class SearchLocationWidget extends StatelessWidget {
  ...
  const SearchLocationWidget(
      {super.key, required this.mapController, required this.pickedAddress, required this.isEnabled, this.isPickedUp, this.hint, this.fromDialog = false});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(children: [
          (/*!fromDialog! &&*/ pickedAddress != null && pickedAddress!.isNotEmpty)
              ? Icon(
                  Icons.location_on,
                  size: 25,
