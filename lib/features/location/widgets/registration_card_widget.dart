          ...
          Expanded(
              ...
              child: Padding(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  splashController.landingModel!.joinSellerButtonName != null || splashController.landingModel!.joinDeliveryManButtonName != null
                      ? CustomButton(
                          buttonText: isStore
                              ? splashController.landingModel!.joinSellerButtonName ?? ''
                              : splashController.landingModel!.joinDeliveryManButtonName ?? '',
                          fontSize: Dimensions.fontSizeSmall,
                          width: 100,
                          height: 40,
                          onPressed: () async {
                            String url = isStore
                                ? splashController.landingModel!.joinSellerButtonUrl ?? ''
                                : splashController.landingModel!.joinDeliveryManButtonUrl ?? '';
