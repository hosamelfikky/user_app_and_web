...
class AddAddressScreen extends StatefulWidget {
  ...
  const AddAddressScreen(
      {super.key, required this.fromCheckout, required this.fromRide, this.address, this.zoneId, this.forGuest = false, this.fromNavBar = false});
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                color: locationController.addressTypeIndex == index
                                                    ...
                                                    : Theme.of(context).cardColor,
                                                boxShadow: locationController.addressTypeIndex == index
                                                    ? null
                                                    : const [BoxShadow(color: Colors.black12, spreadRadius: 1, blurRadius: 5)],
                                                border: Border.all(
                                                    color: locationController.addressTypeIndex == index
                                                        ? Theme.of(context).primaryColor
                                                        : Theme.of(context).disabledColor)),
