                  ...
                  ? Padding(
                      ...
                      child: Text(
                        ...
                        style: robotoMedium.copyWith(
                            fontSize: Dimensions.fontSizeExtraLarge, color: isDesktop ? Theme.of(context).textTheme.titleSmall!.color : Colors.red),
                      ),
                    )
                  : const SizedBox(),
              Padding(
                ...
                child: Text(description,
                    style: isDesktop
                        ? robotoRegular.copyWith(fontSize: isDesktop ? Dimensions.fontSizeSmall : Dimensions.fontSizeLarge, color: Theme.of(context).hintColor)
                        : robotoMedium.copyWith(fontSize: isDesktop ? Dimensions.fontSizeSmall : Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
                    textAlign: TextAlign.center),
              ),
