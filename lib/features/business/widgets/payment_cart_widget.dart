  ...
  Widget build(BuildContext context) {
    return GetBuilder<BusinessController>(builder: (businessController) {
      return Stack(clipBehavior: Clip.none, children: [
            ...
            child: Row(children: [
              Text(title,
                  style: robotoBold.copyWith(
                      color: businessController.paymentIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge!.color)),
              const Spacer(),
              (ResponsiveHelper.isDesktop(context) && businessController.paymentIndex == index)
                  ? Container(
        ...
        (ResponsiveHelper.isMobile(context) && businessController.paymentIndex == index)
            ? Positioned(
                top: -8,
                right: -8,
                child: Container(
