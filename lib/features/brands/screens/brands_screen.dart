              ...
              SizedBox(
                ...
                child: brandsController.brandList != null
                    ? brandsController.brandList!.isNotEmpty
                            ...
                            itemBuilder: (context, index) {
                              return InkWell(
                                ...
                                child: Row(children: [
                                  ...
                                  Flexible(
                                    child: Text(brandsController.brandList![index].name ?? '',
                        ...
                        : Center(
                            child: Padding(
                                padding: EdgeInsets.only(top: isDesktop ? context.height * 0.3 : context.height * 0.4), child: Text('no_brands_found'.tr)))
                    : Center(
                        child: Padding(
                            padding: EdgeInsets.only(top: isDesktop ? context.height * 0.3 : context.height * 0.4), child: const CircularProgressIndicator())),
              ),
            ]),
          ),
        );
