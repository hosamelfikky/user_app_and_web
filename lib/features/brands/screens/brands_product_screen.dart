              ...
              SizedBox(
                ...
                child: brandsController.brandItemModel != null
                    ? brandsController.brandItemModel!.items!.isNotEmpty
                        ...
                        : Center(
                            child: Padding(
                                padding: EdgeInsets.only(top: isDesktop ? context.height * 0.3 : context.height * 0.4), child: Text('no_brand_item_found'.tr)))
              ...
              return Shimmer(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                          color: Get.isDarkMode ? Colors.black12 : Colors.grey.withOpacity(0.1), spreadRadius: 1, blurRadius: 5, offset: const Offset(0, 1))
                    ],
                  ),
                  child: Row(children: [
                    Container(
