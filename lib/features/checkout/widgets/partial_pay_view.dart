      ...
      return Get.find<SplashController>().configModel!.partialPaymentStatus! &&
          ...
          ? AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color:
                    Get.find<ThemeController>().darkTheme ? Theme.of(context).primaryColor.withOpacity(0.2) : Theme.of(context).primaryColor.withOpacity(0.05),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color:
                                    checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Colors.red : Theme.of(context).primaryColor,
                                width: 0.5),
                            borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                          ),
                          ...
                          child: Text(
                            ...
                            style: robotoBold.copyWith(
                                ...
                                color: checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Colors.red : Colors.white),
                          ),
                        ),
                      ),
                    ])
