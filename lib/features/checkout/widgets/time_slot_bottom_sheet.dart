...
import 'package:user_app_web/features/checkout/widgets/slot_widget.dart';
                ...
                Flexible(
                  child: Padding(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Flexible(
                        child: ((checkoutController.selectedDateSlot == 0 && widget.todayClosed) ||
                                        ...
                                        itemBuilder: (context, index) {
                                          String time = (index == 0 &&
                                                  ...
                                                  (Get.find<SplashController>().configModel!.moduleConfig!.module!.orderPlaceToScheduleInterval!
                                                      ? storeController.store!.orderPlaceToScheduleInterval == 0
                                                      : true))
                                              ? 'instance'.tr
