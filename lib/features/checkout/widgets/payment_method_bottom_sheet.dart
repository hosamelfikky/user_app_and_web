...
import 'package:user_app_web/features/checkout/widgets/payment_button_new.dart';
                ...
                child: GetBuilder<CheckoutController>(builder: (checkoutController) {
                  return Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: Dimensions.paddingSizeLarge),
                      notHideCod && (widget.isCashOnDeliveryActive && notHideCod) ||
                              (widget.storeId == null && widget.isWalletActive && notHideWallet && isLoggedIn)
                            ...
                            ? Expanded(
                                child: Padding(
                                  padding: EdgeInsets.only(
                                      right: widget.storeId == null && widget.isWalletActive && notHideWallet && isLoggedIn ? Dimensions.paddingSizeSmall : 0),
                      ...
                      const SizedBox(height: Dimensions.paddingSizeLarge),
                      widget.storeId == null && widget.isDigitalPaymentActive && notHideDigital
                          ? Row(children: [
                          ...
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                bool isSelected = checkoutController.paymentMethodIndex == 2 &&
                                    Get.find<SplashController>().configModel!.activePaymentMethodList![index].getWay! == checkoutController.digitalPaymentName;
                                return InkWell(
                                  onTap: () {
                                    checkoutController.setPaymentMethod(2);
                                    checkoutController
                                        .changeDigitalPaymentName(Get.find<SplashController>().configModel!.activePaymentMethodList![index].getWay!);
                                  },
                                  child: Container(
                                    decoration: BoxDecoration(
