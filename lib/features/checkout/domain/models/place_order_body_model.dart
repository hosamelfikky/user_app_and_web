...
class PlaceOrderBodyModel {
  ...
  PlaceOrderBodyModel.fromJson(Map<String, dynamic> json) {
    ...
    _extraPackagingAmount =
        json['extra_packaging_amount'] != null && json['extra_packaging_amount'] != 'null' ? double.parse(json['extra_packaging_amount'].toString()) : null;
...
class OnlineCart {
  ...
  OnlineCart(int? cartId, int? itemId, int? itemCampaignId, String price, String variant, List<Variation>? variation, List<OrderVariation>? variations,
      int? quantity, List<int?> addOnIds, List<AddOns>? addOns, List<int?> addOnQtys, String model,
      {String? itemType}) {
    _cartId = cartId;
    _itemId = itemId;
