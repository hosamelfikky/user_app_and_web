                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                ...
                                Text(PriceConverter.convertPrice(widget.orderDetailsList[index].itemDetails!.price),
                            ...
                            itemBuilder: (context, i) {
                              return InkWell(
                                child: Icon(
                                  ...
                                  size: 25,
                                  color: reviewController.ratingList[index] < (i + 1) ? Theme.of(context).disabledColor : Theme.of(context).primaryColor,
                                ),
                                onTap: () {
