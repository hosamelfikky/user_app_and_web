...
import 'package:user_app_web/features/item/widgets/details_app_bar_widget.dart';
import 'package:user_app_web/features/item/widgets/details_web_view_widget.dart';
import 'package:user_app_web/features/item/widgets/item_image_view_widget.dart';
      ...
      return GetBuilder<ItemController>(
        builder: (itemController) {
          ...
          if (itemController.item != null && itemController.variationIndex != null) {
            ...
            double? discount = (itemController.item!.availableDateStarts != null || itemController.item!.storeDiscount == 0)
                ? itemController.item!.discount
                : itemController.item!.storeDiscount;
            String? discountType =
                (itemController.item!.availableDateStarts != null || itemController.item!.storeDiscount == 0) ? itemController.item!.discountType : 'percent';
            ...
            cart = OnlineCart(
                ...
                variation != null ? [variation] : [],
                null,
                itemController.cartIndex != -1 ? cartController.cartList[itemController.cartIndex].quantity : itemController.quantity,
                listOfAddOnId,
                addOnsList,
                listOfAddOnQty,
                'Item');
                                        ...
                                        child: SizedBox(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                ListView.builder(
                                                  ...
                                                  itemBuilder: (context, index) {
                                                    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                      Text(itemController.item!.choiceOptions![index].title!,
                                                          ...
                                                          return InkWell(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                ...
                                                                border: itemController.variationIndex![index] != i
                                                      ...
                                                      SizedBox(
                                                          height: index != itemController.item!.choiceOptions!.length - 1 ? Dimensions.paddingSizeLarge : 0),
                                                    ]);
                                                  },
                                                ),
                                                      ...
                                                      child: Row(children: [
                                                              ...
                                                              : () {
                                                                  if (itemController.cartIndex != -1) {
                                                                    if (cartController.cartList[itemController.cartIndex].quantity! > 1) {
                                                                      cartController.setQuantity(false, itemController.cartIndex, stock,
                                                        ...
                                                        InkWell(
                                                          onTap: cartController.isLoading
                                                              ? null
                                                              : () => itemController.cartIndex != -1
                                                                  ? cartController.setQuantity(true, itemController.cartIndex, stock,
                                                ...
                                                (itemController.item!.description != null && itemController.item!.description!.isNotEmpty)
                                                    ? Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
