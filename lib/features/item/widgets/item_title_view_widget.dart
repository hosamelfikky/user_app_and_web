                      ...
                      : Container(
                          ...
                          child: GetBuilder<FavouriteController>(builder: (favouriteController) {
                            return InkWell(
                              ...
                              child: Icon(
                                favouriteController.wishItemIdList.contains(itemController.item!.id) ? Icons.favorite : Icons.favorite_border,
                                size: 25,
                            ...
                            return Row(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Icon(
                                    favouriteController.wishItemIdList.contains(item!.id) ? Icons.favorite : Icons.favorite_border,
                                    size: 25,
                                    color: favouriteController.wishItemIdList.contains(item!.id)
