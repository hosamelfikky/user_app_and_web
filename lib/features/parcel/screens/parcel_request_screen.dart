...
import 'package:user_app_web/features/payment/widgets/offline_payment_button.dart';
import 'package:user_app_web/features/checkout/widgets/payment_button.dart';
import 'package:user_app_web/features/checkout/widgets/tips_widget.dart';
import 'package:user_app_web/features/parcel/widgets/card_widget.dart';
import 'package:user_app_web/features/parcel/widgets/delivery_instruction_bottom_sheet_widget.dart';
            ...
            ? GetBuilder<ParcelController>(builder: (parcelController) {
                ...
                if (parcelController.distance != -1 && parcelController.extraCharge != null) {
                  charge = _calculateParcelDeliveryCharge(
                      parcelController: parcelController, parcelCategory: widget.parcelCategory, zoneId: widget.pickedUpAddress.zoneId!);
                    ...
                    child: FooterView(
                        child: SizedBox(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              CardWidget(
                                child: Padding(
                                  ...
                                  child: Column(children: [
                                    ...
                                    SizedBox(
                                        height: parcelController.selectedIndexNote != -1 || parcelController.customNote!.isNotEmpty
                                            ? Dimensions.paddingSizeSmall
                                            : 0),
                                    (parcelController.selectedIndexNote != -1 || parcelController.customNote!.isNotEmpty)
                                        ? Row(children: [
                                  ...
                                  ? Container(
                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: (parcelController.selectedTips == AppConstants.tips.length - 1) && parcelController.canShowTipsField
                                              ? const SizedBox()
                                              : ListView.builder(
                                                    ...
                                                    return TipsWidget(
                                                      ...
                                                      onTap: () {
                                                        ...
                                                        if (parcelController.selectedTips != 0 &&
                                                            parcelController.selectedTips != AppConstants.tips.length - 1) {
                                        ...
                                        SizedBox(
                                            height: (parcelController.selectedTips == AppConstants.tips.length - 1) && parcelController.canShowTipsField
                              ...
                              Row(children: [
                                ...
                                SizedBox(
                                    width: (Get.find<SplashController>().configModel!.customerWalletStatus == 1 &&
                                        ...
                                        : 0),
                                (Get.find<SplashController>().configModel!.customerWalletStatus == 1 && parcelController.payerIndex == 0 && !isGuestLoggedIn)
                                    ? Expanded(
                                        child: PaymentButton(
                                          icon: Images.wallet,
                              ...
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                              (_isDigitalPaymentActive! && parcelController.payerIndex == 0)
                                  ? Column(children: [
                                      Row(children: [
                                      ...
                                      ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            bool isSelected = parcelController.paymentIndex == 2 &&
                                                Get.find<SplashController>().configModel!.activePaymentMethodList![index].getWay! ==
                                                    parcelController.digitalPaymentName;
                                            return InkWell(
                                              onTap: () {
                                  ...
                                  : const SizedBox(),
                              parcelController.offlineMethodList != null && parcelController.payerIndex == 0
          ...
          ? () {
              if (parcelController.distance == -1) {
                ...
                showCustomSnackBar('enter_confirm_password'.tr);
                  ...
                  (_guestPasswordController.text != _guestConfirmPasswordController.text)) {
                ...
                PlaceOrderBodyModel placeOrderBody = PlaceOrderBodyModel(
                  ...
                  chargePayer: parcelController.payerTypes[parcelController.payerIndex],
                  dmTips: parcelController.tips.toString(),
                  cutlery: 0,
                  unavailableItemNote: '',
                  deliveryInstruction:
                      (isInstructionSelected ? '${parcelController.parcelInstructionList![parcelController.selectedIndexNote!].instruction}' : '') +
                          (isInstructionSelected
                              ? (isCustomNote ? " (${parcelController.customNote})" : '')
                              : (isCustomNote ? parcelController.customNote ?? '' : '')),
                  partialPayment: 0,
                  guestId: AuthHelper.isGuestLoggedIn() ? int.parse(AuthHelper.getGuestId()) : 0,
                  isBuyNow: 0,
