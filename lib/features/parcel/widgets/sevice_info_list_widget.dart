                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: index == title.length - 1
                        ? null
                        : Border(
                            left: Get.find<LocalizationController>().isLtr ? BorderSide(width: 1, color: Theme.of(context).disabledColor) : BorderSide.none,
                            right: Get.find<LocalizationController>().isLtr ? BorderSide.none : BorderSide(width: 1, color: Theme.of(context).disabledColor)),
                  ),
                  child: Text(
                    subTitle![index],
