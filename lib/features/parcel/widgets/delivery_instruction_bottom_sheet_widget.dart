                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                ...
                                child: SelectedCardWidget(
                                    title: parcelController.parcelInstructionList![index].instruction!,
                                    isSelect: parcelController.instructionselectedIndex == index),
                              ),
                            );
                          },
                        )
    ...
    return Container(
      ...
      child: Row(children: [
        Icon(isSelect ? Icons.check_circle : Icons.radio_button_off,
            color: isSelect ? Theme.of(context).primaryColor : Theme.of(context).disabledColor, size: 25),
