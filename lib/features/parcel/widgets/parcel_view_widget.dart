...
class _ParcelViewWidgetState extends State<ParcelViewWidget> {
                                        ...
                                        onPicked: (AddressModel address) async {
                                          if (parcelController.isPickedUp!) {
                                            ZoneResponseModel responseModel =
                                                await Get.find<LocationController>().getZone(address.latitude.toString(), address.longitude.toString(), false);
                            ...
                            child: CustomDropdown<int>(
                              ...
                              child: AddressWidget(
                                address: parcelController.isSender
                                    ? senderAddress[parcelController.senderAddressIndex!]
                                    : receiverAddress[parcelController.receiverAddressIndex!],
                                fromAddress: false,
                                fromCheckout: true,
                              ),
                            ),
  ...
  List<AddressModel> _getAddressList(
      {required List<AddressModel>? addressList, required bool isSender, required AddressModel? pickupAddress, required AddressModel? destinationAddress}) {
