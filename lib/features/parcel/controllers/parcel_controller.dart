...
import '../domain/models/video_content_model.dart';
import '../domain/models/why_choose_model.dart';
import '../domain/services/parcel_service_interface.dart';
...
class ParcelController extends GetxController implements GetxService {
  ...
  Future<String> placeOrder(
      PlaceOrderBodyModel placeOrderBody, int? zoneID, double amount, double? maximumCodOrderAmount, bool fromCart, bool isCashOnDeliveryActive,
      {bool forParcel = false, bool isOfflinePay = false}) async {
    _isLoading = true;
    update();
    String orderID = '';
  ...
  Future<void> parcelCallback(bool isSuccess, String? message, String orderID, int? zoneID, double orderAmount, double? maxCodAmount,
      bool isCashOnDeliveryActive, String? contactNumber,
