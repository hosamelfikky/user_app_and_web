...
import 'package:user_app_web/features/order/widgets/delivery_details_widget.dart';
import 'package:user_app_web/features/payment/widgets/offline_info_edit_dialog_widget.dart';
import 'package:user_app_web/features/order/widgets/order_banner_view_widget.dart';
...
import 'package:user_app_web/features/review/widgets/review_dialog_widget.dart';
    ...
    return Stack(children: [
      ...
      Column(
        ...
        children: [
                  ...
                  ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      RichText(
                        text: TextSpan(
                            ...
                            children: <TextSpan>[TextSpan(text: order.deliveryInstruction!, style: robotoRegular)]),
                      ),
                    ])
                  : const SizedBox(),
                      ...
                      order.orderStatus == 'refund_requested'
                          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              (order.refund != null && order.refund!.customerNote != null)
                                  ? InkWell(
                                      onTap: () =>
                                          Get.dialog(ReviewDialogWidget(review: ReviewModel(comment: order.refund!.customerNote), fromOrderDetails: true)),
                                      child: Text(
          ...
          (order.orderStatus == 'delivered' && order.orderProofFullUrl != null && order.orderProofFullUrl!.isNotEmpty)
              ? Container(
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
                    boxShadow: [BoxShadow(color: Theme.of(context).primaryColor.withOpacity(0.05), blurRadius: 10)],
                                  ...
                                  ? InkWell(
                                      onTap: () async {
                                        ...
                                        await Get.toNamed(RouteHelper.getChatRoute(
                                          notificationBody:
                                              NotificationBodyModel(deliverymanId: order.deliveryMan!.id, orderId: int.parse(order.id.toString())),
                                          user: User(
                      ...
                      : Row(children: [
                          ...
                          !isGuestLoggedIn &&
                                  (Get.find<SplashController>().configModel!.refundActiveStatus! &&
                                      order.orderStatus == 'delivered' &&
                                      !parcel &&
                                      (parcel || (orderController.orderDetails!.isNotEmpty && orderController.orderDetails![0].itemCampaignId == null)))
                              ? InkWell(
      ...
      child: ExpansionTile(
        ...
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            (ongoing && orderController.trackModel!.offlinePayment != null && orderController.trackModel!.offlinePayment!.data!.status != 'verified')
                ? InkWell(
                    onTap: () {
                      Get.dialog(
                          OfflineInfoEditDialogWidget(offlinePayment: orderController.trackModel!.offlinePayment!, orderId: orderController.trackModel!.id!),
