...
import 'package:user_app_web/common/widgets/custom_dialog.dart';
...
import 'package:user_app_web/features/checkout/widgets/offline_success_dialog.dart';
...
import 'package:user_app_web/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:user_app_web/features/order/widgets/order_calcuation_widget.dart';
import 'package:user_app_web/features/order/widgets/order_info_widget.dart';
import 'package:user_app_web/features/review/screens/rate_review_screen.dart';
...
class OrderDetailsScreen extends StatefulWidget {
  ...
  const OrderDetailsScreen(
      {super.key, required this.orderModel, required this.orderId, this.fromNotification = false, this.fromOfflinePayment = false, this.contactNumber});
...
class OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void _loadData(BuildContext context, bool reload) async {
    await Get.find<OrderController>()
        .trackOrder(widget.orderId.toString(), reload ? null : widget.orderModel, false, contactNumber: widget.contactNumber)
        .then((value) {
    ...
    return Column(children: [
      ...
      !AuthHelper.isGuestLoggedIn() &&
              (order.orderStatus == 'delivered' &&
                  (parcel ? order.deliveryMan != null : (orderController.orderDetails!.isNotEmpty && orderController.orderDetails![0].itemCampaignId == null)))
          ? Center(
              child: Container(
                width: Dimensions.webMaxWidth,
