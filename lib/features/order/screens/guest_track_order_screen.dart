                        ...
                        ? Column(children: [
                            ...
                            Column(children: [
                              ...
                              GuestCustomStepperWidget(
                                ...
                                isComplete: status == AppConstants.handover || status == AppConstants.pickedUp || status == AppConstants.delivered,
                                statusImage: Images.trackOrderOnTheWay,
                                isActive: status == AppConstants.handover,
                                subTitle: 'your_delivery_man_is_coming'.tr,
                                trailing: orderController.trackModel?.deliveryMan?.phone != null
                                    ? InkWell(
                                        onTap: () async {
                              ...
                              GuestCustomStepperWidget(
                                ...
                                child: orderController.trackModel?.deliveryMan != null
                                    ? TrackingMapWidget(
                  ...
                  isDesktop
                      ? Padding(
                          ...
                          child: CustomButton(
                            ...
                            onPressed: () {
                              Get.toNamed(
                                RouteHelper.getOrderDetailsRoute(int.parse(widget.orderId), contactNumber: widget.number),
                              );
                            },
                          ),
                        )
