...
import 'package:user_app_web/common/models/translation.dart';
...
import 'package:user_app_web/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:user_app_web/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:user_app_web/features/auth/widgets/module_view_widget.dart';
import 'package:user_app_web/features/auth/widgets/pass_view_widget.dart';
import 'package:user_app_web/features/auth/widgets/select_location_view_widget.dart';
                                    ...
                                    Container(
                                      ...
                                      child: Column(children: [
                                        ...
                                        CustomTextField(
                                          ...
                                          nextFocus:
                                              _tabController!.index != _languageList!.length - 1 ? _addressFocus[_tabController!.index] : _addressFocus[0],
                                                            ...
                                                            : SizedBox(
                                                                ...
                                                                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                  Icon(CupertinoIcons.photo_camera_solid,
                                                                      size: 30, color: Theme.of(context).disabledColor.withOpacity(0.6)),
                                                                  const SizedBox(height: Dimensions.paddingSizeSmall),
                                                                  Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(children: [
                                      Get.find<SplashController>().configModel!.commissionBusinessModel != 0
                                          ...
                                          : const SizedBox(),
                                      SizedBox(
                                          width: Get.find<SplashController>().configModel!.commissionBusinessModel != 0 ? Dimensions.paddingSizeDefault : 0),
                                      Get.find<SplashController>().configModel!.subscriptionBusinessModel != 0
                                          ? Expanded(
                                              child: BaseCardWidget(
                                                storeRegistrationController: storeRegController,
                                  ...
                                  storeRegController.businessIndex == 0
                                      ...
                                      : Column(children: [
                                          ...
                                          storeRegController.packageModel != null
                                              ? SizedBox(
                                                  height: 420,
                                                  child: storeRegController.packageModel!.packages!.isNotEmpty
                                                      ? Swiper(
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Expanded(
                      child: Column(children: [
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                        storeRegController.zoneList != null
                            ? const SelectLocationViewWidget(fromView: true, mapView: true)
                            : const Center(child: CircularProgressIndicator()),
                      ]),
                    ),
                  ]),
                                          ...
                                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'upload_jpg_png_gif_maximum_2_mb'.tr,
                                                style: robotoRegular.copyWith(
                                                    color: Theme.of(context).disabledColor.withOpacity(0.6), fontSize: Dimensions.fontSizeOverSmall),
                                                textAlign: TextAlign.center,
                                              ),
                                            ),
                                          ]),
                                  ...
                                  : SizedBox(
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        ...
                                        Text(
                                          ...
                                          style: robotoRegular.copyWith(
                                              color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(0.7), fontSize: Dimensions.fontSizeExtraSmall),
                                          textAlign: TextAlign.center,
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
      ...
      return Container(
        ...
        child: CustomButton(
          ...
          onPressed: (storeRegController.storeStatus == 0.1 && !ResponsiveHelper.isDesktop(context) && !storeRegController.inZone) ||
                  (ResponsiveHelper.isDesktop(context) && !storeRegController.inZone)
              ? null
              : () {
                  ...
                  if (storeRegController.storeStatus == 0.1 || storeRegController.storeStatus == 0.6) {
                    ...
                    storeRegController.registerStore(StoreBodyModel(
                      ...
                      email: email,
                      lng: storeRegController.restaurantLocation!.longitude.toString(),
                      fName: fName,
                      lName: lName,
                      ...
                      packageId: storeRegController.businessIndex == 0
                          ? ''
                          : storeRegController.packageModel!.packages![storeRegController.activeSubscriptionIndex].id!.toString(),
                    ));
                  }
                },
        ),
