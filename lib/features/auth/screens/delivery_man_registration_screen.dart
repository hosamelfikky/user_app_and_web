...
import 'package:user_app_web/features/auth/widgets/condition_check_box_widget.dart';
        ...
        body: GetBuilder<DeliverymanRegistrationController>(builder: (deliverymanRegistrationController) {
          ...
          return SafeArea(
              child: ResponsiveHelper.isDesktop(context)
                  ? webView(deliverymanRegistrationController, zoneList, dmTypeList, vehicleList, identityTypeList)
                  : Column(children: [
                      Padding(
                                        ...
                                        Align(
                                            ...
                                            child: Stack(clipBehavior: Clip.none, children: [
                                              ClipRRect(
                                                ...
                                                child: deliverymanRegistrationController.pickedImage != null
                                                    ? GetPlatform.isWeb
                                                        ? Image.network(
                                                            deliverymanRegistrationController.pickedImage!.path,
                                                            width: 150,
                                                            height: 120,
                                                            fit: BoxFit.cover,
                                                          )
                                                        : Image.file(
                                                            File(deliverymanRegistrationController.pickedImage!.path),
                                                            width: 150,
                                                            height: 120,
                                                            fit: BoxFit.cover,
                                                          )
                                              ...
                                              deliverymanRegistrationController.pickedImage != null
                                                  ? Positioned(
                                                      bottom: -10,
                                                      right: -10,
                                                      child: InkWell(
                                  ...
                                  Visibility(
                                    ...
                                    child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                      Row(children: [
                                        ...
                                        const SizedBox(width: Dimensions.paddingSizeLarge),
                                        Expanded(
                                            child: deliverymanRegistrationController.zoneList != null
                                                ? Container(
                                                    decoration: BoxDecoration(
                                                        borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                                        color: Theme.of(context).cardColor,
                                      ...
                                      const SizedBox(height: Dimensions.paddingSizeExtraLarge),
                                      deliverymanRegistrationController.vehicleIds != null
                                          ? Container(
                                              decoration: BoxDecoration(
                                                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                                  color: Theme.of(context).cardColor,
                                      ...
                                      Container(
                                        ...
                                        child: CustomDropdown<int>(
                                          onChange: (int? value, int index) {
                                            deliverymanRegistrationController.setIdentityTypeIndex(
                                                deliverymanRegistrationController.identityTypeList[index], true);
                                          },
                                          dropdownButtonStyle: DropdownButtonStyle(
                                            height: 45,
                                            padding: const EdgeInsets.symmetric(
                                      ...
                                      Form(
                                        ...
                                        child: CustomTextField(
                                          ...
                                          titleText: deliverymanRegistrationController.identityTypeIndex == 0
                                              ? 'Ex: XXXXX-XXXXXXX-X'
                                              : deliverymanRegistrationController.identityTypeIndex == 1
                                                  ? 'L-XXX-XXX-XXX-XXX.'
                                                  : 'XXX-XXXXX',
                  ...
                  Container(
                    ...
                    child: Column(children: [
                                ...
                                ? Container(
                                    ...
                                    child: CustomDropdown<int>(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(deliverymanRegistrationController.selectedZoneIndex == -1
                                            ? 'select_zone'.tr
                                            : deliverymanRegistrationController.zoneList![deliverymanRegistrationController.selectedZoneIndex!].name
                                                .toString()),
                                      ),
                                    ),
                                  )
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                        Container(
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(Dimensions.radiusSmall), border: Border.all(color: Theme.of(context).hintColor)),
                          width: 165,
                          child: CustomButton(
                            transparent: true,
            ...
            : () async {
                if (deliverymanRegistrationController.dmStatus == 0.4 && !ResponsiveHelper.isDesktop(context)) {
                  ...
                  if (_formKeyStep1!.currentState!.validate()) {
                    ...
                    } else if (!deliverymanRegistrationController.spatialCheck ||
