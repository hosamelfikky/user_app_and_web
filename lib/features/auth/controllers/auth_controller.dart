...
class AuthController extends GetxController implements GetxService {
  ...
  Future<ResponseModel> login(String? phone, String password) async {
    ...
    ResponseModel responseModel = await authServiceInterface.login(
        phone: phone, password: password, isCustomerVerificationOn: Get.find<SplashController>().configModel!.customerVerification!);
  ...
  Future<void> loginWithSocialMedia(SocialLogInBody socialLogInBody) async {
    ...
    bool canNavigateToLocation =
        await authServiceInterface.loginWithSocialMedia(socialLogInBody, 60, Get.find<SplashController>().configModel!.customerVerification!);
  ...
  Future<void> registerWithSocialMedia(SocialLogInBody socialLogInBody) async {
    ...
    bool canNavigateToLocationScreen =
        await authServiceInterface.registerWithSocialMedia(socialLogInBody, Get.find<SplashController>().configModel!.customerVerification!);
