            ...
            Container(
              ...
              child: CustomDropdown<int>(
                ...
                child: Padding(
                  ...
                  child: Text(storeRegController.selectedZoneIndex == -1
                      ? 'select_zone'.tr
                      : storeRegController.zoneList![storeRegController.selectedZoneIndex!].name.toString()),
                ),
              ),
            ),
            Positioned(
              ...
              child: Container(
                ...
                child: Text('select_zone'.tr,
                    style: robotoRegular.copyWith(
                        color: Theme.of(context).disabledColor, fontSize: isDesktop ? Dimensions.fontSizeExtraSmall : Dimensions.fontSizeDefault)),
              ),
            ),
          ])
