...
class OfflinePaymentButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return (isOfflinePaymentActive && offlineMethodList != null && offlineMethodList!.isNotEmpty)
        ? InkWell(
                ...
                isSelected
                    ? GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          bool isSelected =
                              !forParcel ? checkoutController.selectedOfflineBankIndex == index : parcelController?.selectedOfflineBankIndex == index;
                          return Container(
                            decoration: BoxDecoration(
                              color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).cardColor,
