...
import 'package:user_app_web/features/chat/widgets/chat_serach_field_widget.dart';
...
import 'package:user_app_web/features/chat/widgets/web_chat_view_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        ...
        floatingActionButton: (chatController.conversationModel != null && !chatController.hasAdmin) && !ResponsiveHelper.isDesktop(context)
                                                          ...
                                                          Positioned(
                                                            ...
                                                            child: Text(
                                                              DateConverter.localDateToIsoStringAMPM(
                                                                  DateConverter.dateTimeStringToDate(conversation.conversations![index]!.lastMessageTime!)),
                                                              style: robotoRegular.copyWith(
