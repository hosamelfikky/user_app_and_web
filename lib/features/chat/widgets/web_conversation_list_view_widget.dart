...
class _WebConversationListViewWidgetState extends State<WebConversationListViewWidget> {
  ...
  Widget build(BuildContext context) {
    User? user;
    return (widget.conversation != null && widget.conversation?.conversations != null)
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    color: (widget.chatController.selectedIndex == index && widget.chatController.type == type)
                                  ...
                                  child: CustomInkWell(
                                    onTap: () {
                                      ...
                                      if (AuthHelper.isLoggedIn()) {
                                        Get.find<ChatController>().getMessages(
                                            ...
                                            user,
                                            widget.conversation?.conversations![index]!.id,
                                            firstLoad: true);
                                    ...
                                    child: Stack(children: [
                                      Padding(
                                        ...
                                        child: Row(children: [
                                          ...
                                          Expanded(
                                            ...
                                            widget.conversation!.conversations![index]!.lastMessage != null
                                                ? Text(
                                      ...
                                      Positioned(
                                        right: Get.find<LocalizationController>().isLtr ? 5 : null,
                                        top: 15,
                                        left: Get.find<LocalizationController>().isLtr ? null : 5,
                                        child: Text(
                                      ...
                                      GetBuilder<ProfileController>(builder: (profileController) {
                                        return (profileController.userInfoModel != null &&
                                                profileController.userInfoModel!.userInfo != null &&
                                                widget.conversation!.conversations![index]!.lastMessage!.senderId !=
                                                    profileController.userInfoModel!.userInfo!.id &&
                                                widget.conversation!.conversations![index]!.unreadMessageCount! > 0)
                                            ? Positioned(
                                                right: Get.find<LocalizationController>().isLtr ? 5 : null,
                                                bottom: 8,
                                                left: Get.find<LocalizationController>().isLtr ? null : 5,
                                ...
                                index + 1 == widget.conversation!.conversations!.length
                                    ? const SizedBox()
