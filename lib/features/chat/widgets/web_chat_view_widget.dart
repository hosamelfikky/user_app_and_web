                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            (AuthHelper.isLoggedIn() &&
                                    ...
                                    widget.chatController.conversationModel!.conversations!.isNotEmpty)
                                ? Center(
                                    child: SizedBox(
                                        width: Dimensions.webMaxWidth,
                                        child: WebSearchField(
                                          prefixWidget: widget.chatController.searchConversationModel != null
                                              ? null
                                              : Padding(
                                      ...
                                      child: Builder(builder: (context) {
                                        return Container(
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                            color: widget.chatController.selectedIndex == -1
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Column(children: [
                                      ...
                                      Expanded(
                                        ...
                                        Row(
                                          children: [
                                            Flexible(
                                              child: Text(
                                                widget.chatController.notificationBody!.name!,
                                                style: robotoMedium,
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                              ),
                                            ),
                                            Text('(${widget.chatController.notificationBody!.receiverType!.tr})',
                            ...
                            /// Chat
                            Expanded(
                                child: widget.chatController.notificationBody != null
                                    ? widget.chatController.messageModel != null
                                        ? widget.chatController.messageModel!.messages!.isNotEmpty
                                                ...
                                                child: PaginatedListView(
                                                  ...
                                                  onPaginate: (int? offset) async => await widget.chatController.getMessages(
                                                    ...
                                                    NotificationBodyModel(
                                                      ...
                                                      deliverymanId:
                                                          widget.chatController.notificationBody!.type == UserType.delivery_man.name ? user?.id : null,
                                                    ),
                                                    user,
                                                    widget.chatController.notificationBody!.conversationId,
                                                  ),
                                                  itemView: ListView.builder(
                                                    ...
                                                    itemBuilder: (context, index) {
                                                      return MessageBubbleWidget(
                                                        ...
                                                        userType: widget.chatController.notificationBody!.adminId != null
                                                            ? UserType.admin.name
                                                            : widget.chatController.notificationBody!.deliverymanId != null
                                    ...
                                    : Center(child: Text('no_conversation_selected'.tr))),
                                    ...
                                    InkWell(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Image.asset(
                                          ...
                                          width: 25,
                                          height: 25,
                                          color: widget.chatController.chatImage.isNotEmpty ? Theme.of(context).primaryColor : Theme.of(context).hintColor,
                                        ),
                                      ),
                                    ),
                                    GetBuilder<ChatController>(builder: (chatController) {
                                      return chatController.isLoading
                                          ? const Padding(
                                              padding: EdgeInsets.only(
                                                  left: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeSmall),
                                              ...
                                              onTap: () async {
                                                if (chatController.isSendButtonActive) {
                                                  await chatController.sendMessage(
                                                    ...
                                                    notificationBody: chatController.notificationBody,
                                                    conversationID: chatController.notificationBody!.conversationId,
                                                    index: chatController.notificationBody!.index,
                                                  );
