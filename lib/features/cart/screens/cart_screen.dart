...
import 'package:user_app_web/features/cart/widgets/extra_packaging_widget.dart';
import 'package:user_app_web/features/cart/widgets/not_available_bottom_sheet_widget.dart';
import 'package:user_app_web/features/cart/widgets/web_cart_items_widget.dart';
import 'package:user_app_web/features/cart/widgets/web_suggested_item_view_widget.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<void> initCall() async {
    ...
    if (Get.find<CartController>().cartList.isNotEmpty) {
      log('----cart item : ${Get.find<CartController>().cartList[0].toJson()}');
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text('subtotal'.tr,
                      style: robotoMedium.copyWith(
                          color: ResponsiveHelper.isDesktop(context) ? Theme.of(context).textTheme.bodyLarge!.color : Theme.of(context).primaryColor)),
