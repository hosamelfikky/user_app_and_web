...
class _MenuScreenState extends State<MenuScreen> {
                                      ...
                                      ? PortionWidget(
                                          ...
                                          suffix: !isLoggedIn
                                              ...
                                              : PriceConverter.convertPrice(
                                                  profileController.userInfoModel != null ? profileController.userInfoModel!.walletBalance : 0),
                                        )
                                      : const SizedBox(),
                                ],
                              ),
                                  ...
                                  child: Column(children: [
                                    (Get.find<SplashController>().configModel!.refEarningStatus == 1)
                                        ? PortionWidget(
                                            ...
                                            hideDivider: (Get.find<SplashController>().configModel!.toggleDmRegistration! &&
  ...
  _manageLanguageFunctionality() async {
