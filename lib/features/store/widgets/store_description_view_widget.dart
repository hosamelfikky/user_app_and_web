                              ...
                              child: Center(
                                child: Row(
                                  children: [
                                    ...
                                    Text('wish_list'.tr,
                                        style: robotoRegular.copyWith(fontWeight: FontWeight.w200, color: Colors.white, fontSize: Dimensions.fontSizeSmall)),
                                  ],
                                ),
                              ),
                            )
              ...
              child: Row(children: [
                ...
                InkWell(
                  onTap: () => Get.toNamed(RouteHelper.getMapRoute(
                    ...
                    'store',
                    Get.find<SplashController>().getModuleConfig(Get.find<SplashController>().module!.moduleType!).newVariation!,
