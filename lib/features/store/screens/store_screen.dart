...
import 'package:user_app_web/common/widgets/web_item_view.dart';
...
import 'package:user_app_web/features/store/widgets/customizable_space_bar_widget.dart';
import 'package:user_app_web/features/store/widgets/store_banner_widget.dart';
import 'package:user_app_web/features/store/widgets/store_description_view_widget.dart';
import 'package:user_app_web/features/store/widgets/store_details_screen_shimmer_widget.dart';
                                                      ...
                                                      child: Column(
                                                        ...
                                                        Text(
                                                          ...
                                                          style: robotoRegular.copyWith(
                                                              fontSize: Dimensions.fontSizeSmall - (scrollingRate * 2), color: Theme.of(context).disabledColor),
                                                        ),
                                                        SizedBox(height: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeExtraSmall : 0),
                                                        Row(children: [
                                                          Flexible(
                                                            child: Text('minimum_order'.tr,
                                                                style: robotoRegular.copyWith(
                                                    ...
                                                    return InkWell(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          decoration: BoxDecoration(
                                                              gradient: LinearGradient(begin: Alignment.bottomRight, end: Alignment.topLeft, colors: <Color>[
                                                                  ...
                                                                  onClick: () {
                                                                    if (storeController.isSearching) {
                                                                      ...
                                                                      storeController.getStoreItemList(
                                                                          storeController.store!.id, 1, Get.find<ItemController>().itemTypeList[index], true);
                                                                    }
                                                                  },
                                                                ),
                                                              ),
                                ...
                                store?.announcementActive ?? false
                                    ? Container(
                                        ...
                                        child: Row(children: [
                                          ...
                                          const SizedBox(width: Dimensions.paddingSizeSmall),
                                          Flexible(
                                              child: Text(store?.announcementMessage ?? '', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall))),
                                        ]),
                                      )
                                    : const SizedBox(),
